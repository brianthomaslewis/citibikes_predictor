...
raw_stations_columns = ['station_id', 'name', 'latitude', 'longitude', 'capacity', 'num_bikes_available',
                        'last_reported']
...
def test_process_bike_data():
    ...
    expected_output = pd.DataFrame({
        ...
        'date': ['2020-03-01 06:00:00', '2020-03-01 09:00:00', '2020-03-01 10:00:00', '2020-03-01 11:00:00',
                 '2020-03-01 12:00:00', '2020-03-01 13:00:00', '2020-03-01 14:00:00', '2020-03-01 15:00:00'],
        'name': ['W 52 St & 11 Ave', 'W 52 St & 11 Ave', 'W 52 St & 11 Ave', 'W 52 St & 11 Ave',
                 'W 52 St & 11 Ave', 'W 52 St & 11 Ave', 'W 52 St & 11 Ave', 'W 52 St & 11 Ave'],
