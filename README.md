...
- [Environment setup before running commands in Docker](#environment-setup-before-running-commands-in-docker)
  * [1. Configure Resources in Docker](#2-configure-resources-in-docker)
  * [2. Set AWS credentials and source required environmental variables](#3-set-aws-credentials-and-source-required-environmental-variables)
...
- [Running the web app in Docker](#running-the-web-app-in-docker)
  * [1. Configure Flask App](#2-configure-flask-app)
  * [2. Build the web app image](#3-build-the-web-app-image)
  * [3. Run the web app container](#4-run-the-web-app-container)
  * [4. Kill the named web app container](#5-kill-the-named-web-app-container)
- [Testing](#testing)    
...
-  Ensure you have built the data acquisition and model pipeline image in Docker as described in 
   [Step 1](#1-build-the-data-acquisition-and-model-pipeline-image-in-docker)   
